    ...
    public static ByteArrayInputStream listToExcelFile(List<Customer> customers, List<Vehicle> vehicles,
        ...
        try(Workbook workbook = new XSSFWorkbook()){
            ...
            for(int i = 0; i < customers.size(); i++) {
                ...
                dataRow.createCell(4).setCellValue(customers.get(i).getIdentity());
                dataRow.createCell(5).setCellValue(customers.get(i).getProvince_name());
            }

            // Making size of column auto resize to fit with data
            customerSheet.autoSizeColumn(0);
            customerSheet.autoSizeColumn(1);
            ...
            Row row1 = vehicleSheet.createRow(0);
            // Creating header
            ...
            for(int i = 0; i < vehicles.size(); i++) {
                ...
                dataRow.createCell(0).setCellValue(vehicles.get(i).getId());
                dataRow.createCell(1).setCellValue(vehicles.get(i).getCustomer_name());
                dataRow.createCell(2).setCellValue(vehicles.get(i).getBrand_name());
                dataRow.createCell(3).setCellValue(vehicles.get(i).getColor_name());
